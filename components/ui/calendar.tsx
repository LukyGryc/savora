    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-10 md:size-12 aria-disabled:opacity-50 p-0 select-none hover:bg-primary/10 hover:text-primary rounded-lg transition-colors",
        ...
        dropdowns: cn(
          "w-full flex items-center text-base font-medium justify-center h-12 md:h-14 gap-2",
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ChevronLeftIcon className={cn("size-5 md:size-6", className)} {...props} />
            )
          }
